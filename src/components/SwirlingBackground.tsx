// src/components/SwirlingBackground.tsx
// Note: We are keeping the filename but using the Balatro code inside.

import { Renderer, Program, Mesh, Triangle } from "ogl";
import { useEffect, useRef } from "react";
import "./Balatro.css"; // We created this file in the previous step.
...
// The component itself, with default props
const Balatro = ({
  spinRotation = -2.0,
  spinSpeed = 7.0,
  offset = [0.0, 0.0],
