...
const Index = () => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex flex-col items-center justify-center p-4 overflow-hidden ${isDesktop ? 'cursor-none' : ''}`}>
          ...
          <AnimatePresence>
            {isDesktop && !isHovering ? (
              <motion.div
                ...
                animate={{ clipPath: 'circle(100% at 50% 50%)', transition: { duration: 0.8, ease: "easeOut" } }}
                exit={{ clipPath: 'circle(0% at 50% 50%)', transition: { duration: 0.6, ease: "easeIn" } }}
              >
                <Balatro 
                  color1="#a855f7"
                  color2="#4f46e5"
